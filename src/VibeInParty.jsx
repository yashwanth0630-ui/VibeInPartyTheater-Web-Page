...
const logoImg = "/Logo_VibeInPartyTheater.png";
const vidLooping2 = "/EditrdLoopVibeTray(NEW).mp4";
const vidOutlook = "/OutlookVibeinparty.MOV";
...
function Nav() {
  ...
  return (
    <nav className={`nav ${scrolled ? "nav--scrolled" : ""}`}>
      <div className="nav__logo" onClick={() => navigate("/")}>🎉 VibeInPartyTheater</div>
    ...
    <section className="hero" id="hero">
      ...
      <div className="hero__content">
        ...
        <div className="hero__stats">
          ...
          <div className="hero__stat"><span>1</span><p>Unique Rooms</p></div>
          <div className="hero__stat__divider" />
      ...
      <div className="container">
        <div className="footer__top">
          <div className="footer__brand">
            <div className="footer__logo"> <img src={logoImg} alt="VibeInParty Logo" style={{ maxWidth: '150px', marginBottom: '1rem' }} /> </div>
          ...
          <div className="footer__links">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); navigate("/"); }}>Back to Brands</a>
          </div>
...
export default function VibeInParty() {
  return (
    <div className="vibe-in-party-component">
      <Nav />
      <Hero />
      ...
      <section className="section gallery" id="gallery">
        <div className="container">
          <div className="section__tag" style={{ color: "#4dc8ff" }}>Vibe Gallery</div>
          <h2 className="section__title">Experience the Atmosphere</h2>
          <div className="vibe-video-grid">
            <VideoCard 
              src={vidLooping2} 
              title="Party Pulse" 
              description="Feel the energy of our vibrant party spaces."
            />
            <VideoCard 
              src={vidOutlook} 
              title="Theater Outlook" 
              description="Panoramic views of our premium theater setup."
            />
          </div>
        </div>
      </section>
